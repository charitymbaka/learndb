...
const rebaseEntries = [
  ...
  { branch: 'key-value-store-log-mem_before', rebaseTarget: 'key-value-store-simple_after' },
  { branch: 'key-value-store-log-mem_after', rebaseTarget: 'key-value-store-log-mem_before' },
]
